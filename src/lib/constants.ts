...
export const AUTH_TOKEN = 'simpleanalytics.auth';
export const LOCALE_CONFIG = 'simpleanalytics.locale';
export const TIMEZONE_CONFIG = 'simpleanalytics.timezone';
export const DATE_RANGE_CONFIG = 'simpleanalytics.date-range';
export const THEME_CONFIG = 'simpleanalytics.theme';
export const DASHBOARD_CONFIG = 'simpleanalytics.dashboard';
export const LAST_TEAM_CONFIG = 'simpleanalytics.last-team';
export const VERSION_CHECK = 'simpleanalytics.version-check';
export const SHARE_TOKEN_HEADER = 'x-simpleanalytics-share-token';
export const HOMEPAGE_URL = 'https://simpleanalytics.io';
export const DOCS_URL = 'https://docs.simpleanalytics.io';
export const REPO_URL = 'https://github.com/simpleanalytics/simpleanalytics';
export const UPDATES_URL = 'https://api.simpleanalytics.io/v1/updates';
export const TELEMETRY_PIXEL = 'https://i.simpleanalytics.io/a.png';
