export type TrackedProperties = {
   ...
   * @example 'analytics.simpleanalytics.io'
   */
  hostname: string;
   ...
   *
   * @description extracted from `window.navigator.language`
   * @example 'https://analytics.simpleanalytics.io/docs/getting-started'
   */
  referrer: string;
...
export type UmamiTracker = {
  track: {
     ...
     *
     * @example ```
     * simpleanalytics.track('signup-button');
     * ```
     */
     ...
     *
     * @example ```
     * simpleanalytics.track('signup-button', { name: 'newsletter', id: 123 });
     * ```
     */
     ...
     *
     * @example ```
     * simpleanalytics.track({ website: 'e676c9b4-11e4-4ef1-a4d7-87001773e9f2', url: '/home', title: 'Home page' });
     * ```
     */
     ...
     *
     * @example ```
     * simpleanalytics.track((props) => ({ ...props, url: path }));
     * ```
     */
